        ...
        <?php if ($num_stories > 0): ?>
            ...
            <div id="top-stories" class="row">
                ...
                <div id="big-stories" class=" col-md-6 col-sm-6 col-xs-12 ">
                    <div class="media">
                        <a href="#">
                            <img height="265" width="397" src="<?= srcImgArticle($article) ?>"  class="media-object" alt="<?= cleanStr($article->title) ?>" >
                        </a>
                        <div class="content-big-stories">
                            <h4 class="media-heading "><?= linkArticle($top_stories[0]) ?></h4>
                    ...
                    <div id="small-stories" class="col-md-6 col-sm-6 col-xs-12">
                        <?php for ($i = 1; $i < $num_stories; ++$i): $article = $top_stories[$i]; ?>
                            <div class="media sm-stories">
                                <a class="pull-left" href="<?= hrefAriticle($article) ?>">
                                    <img class="media-object" src="<?= srcImgArticle($article) ?>" width="200" height="125" alt="<?= cleanStr($article->title) ?>">
                                </a>
                                <div class="media-body">
                                    <h5 class="media-heading"><a href="<?= hrefAriticle($article) ?>" class="title"><?= word_limiter($article->title, 9) ?></a></h5>
