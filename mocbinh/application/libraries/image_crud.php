...
class image_CRUD {
    ...
    public $width_size = 90;
    public $height_size = 60;
    ...
    protected function _get_delete_url($value) {
        ...
        return site_url($this->folder . $rsegments_array[1] . '/' . $rsegments_array[2] . '/delete_file/' . $value);
    }
    ...
    protected function _create_thumbnail($image_path, $thumbnail_path) {
        $this->image_moo
                ->load($image_path)
                ->resize_crop($this->width_size, $this->height_size)
    ...
    protected function getState() {
        ...
        if (isset($rsegments_array[3]) && is_numeric($rsegments_array[3])) {
            $upload_url = site_url($this->folder . $rsegments_array[1] . '/' . $rsegments_array[2] . '/upload_file/' . $rsegments_array[3]);
            $ajax_list_url = site_url($this->folder . $rsegments_array[1] . '/' . $rsegments_array[2] . '/' . $rsegments_array[3] . '/ajax_list');
            $ordering_url = site_url($this->folder . $rsegments_array[1] . '/' . $rsegments_array[2] . '/ordering');
            $insert_title_url = site_url($this->folder . $rsegments_array[1] . '/' . $rsegments_array[2] . '/insert_title');
            ...
            $upload_url = site_url($this->folder . $rsegments_array[1] . '/' . $rsegments_array[2] . '/upload_file');
            $ajax_list_url = site_url($this->folder . $rsegments_array[1] . '/' . $rsegments_array[2] . '/ajax_list');
            $ordering_url = site_url($this->folder . $rsegments_array[1] . '/' . $rsegments_array[2] . '/ordering');
            $insert_title_url = site_url($this->folder . $rsegments_array[1] . '/' . $rsegments_array[2] . '/insert_title');
...
class Ext_image_CRUD extends image_CRUD {
    ...
    protected function _create_thumbnail($image_path, $thumbnail_path) {
        $this->image_moo->load($image_path)
                ->resize_crop(255, 255)
                ->save($thumbnail_path, true);
    }
