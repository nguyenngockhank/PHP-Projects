<div id="menu-content" class="container">
    <div class="col-lg-9 col-md-9 col-sm-7"> 
        ...
        <div id="dishes-wrapper" class="row tab-content">
            <?php $old_dish = array_shift($dishes) ?>
            <div id="dishes-<?= $old_dish['cat_id'] ?>" class="list-dishes tab-pane active">
                <?php $this->load->view('layout/dish', array('dish' => $old_dish)) ?>
                <?php foreach ($dishes as $dish): ?>
                    <?php if ($dish['cat_id'] != $old_dish['cat_id']): ?>
                    </div>
                    <div id="dishes-<?= $dish['cat_id'] ?>" class="list-dishes tab-pane">
                    <?php endif; ?>
